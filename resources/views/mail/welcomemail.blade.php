                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="580" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a href="{{ url('/') }}" target="_blank"><img class="adapt-img" src="{{ asset('assets/logo/logo.png') }}" alt style="display: block;" height="100"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        ...
                                                                                        {{-- <p>Access Level: {{ $data['role'] }}</p> --}}
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p35t es-p35b es-p10r es-p10l" align="center"><span class="es-button-border"><a href="{{ route('login') }}" class="es-button" target="_blank" style="border-width: 15px 30px;">Login Account</a></span></td>
                                                                                </tr>
                                                                                <tr>
