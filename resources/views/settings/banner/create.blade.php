...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('banner.store') }}" autocomplete="off" class="form-horizontal"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                                ...
                                <div class="col-sm-10 ml-auto mr-auto col-lg-5 col-md-8">
                                    <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                        <textarea class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
                                            ...
                                            aria-required="true">{{ old('title') }}</textarea>
                                        @if ($errors->has('title'))
                                ...
                                <div class="col-sm-10 ml-auto mr-auto col-lg-5 col-md-8">
                                    <div class="form-group{{ $errors->has('details') ? ' has-danger' : '' }}">
                                        <textarea class="form-control{{ $errors->has('details') ? ' is-invalid' : '' }}"
                                            ...
                                            aria-required="true">{{ old('details') }}</textarea>
                            ...
                            <div class="form-group form-file-upload form-file-multiple {{ $errors->has('files') ? ' has-danger' : '' }}"
                                ...
                                <input id="input-file" type="file" name="files" class="inputFileHidden" required="true"
                                    aria-required="true">
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <button type="submit" class="btn btn-success">{{ __('Add Banner') }}</button>
                        </div>
                    </div>
                </form>
            </div>
