...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row" id="category" style="display: none">
                                <div class="offset-md-2 col-sm-6 col-md-6">
                                    <div class="form-group{{ $errors->has('category') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('category') ? ' invalid' : '' }}"
                                            name="name" id="input-category" type="text"
                                            placeholder="{{ __('Enter category') }}" required="true" aria-required="true" />
                                        <span id="name-error" class="error text-danger" style="display: none"
                            ...
                            <div class="row" id="updatecategory" style="display: none">
                                <div class="offset-md-2 col-sm-6 col-md-6">
                                    <div class="form-group{{ $errors->has('category') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('category') ? ' invalid' : '' }}"
                                            name="name" id="update-category" type="text"
                                            placeholder="{{ __('Enter category') }}" required="true" aria-required="true" />
                                        <span id="uname-error" class="error text-danger" style="display: none"
                                            for="input-category">Input for category cannot be empty</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 text-right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-center">
                                                        <button class="btn btn-info btn-link edit" id="{{ $category->id }}"
                                                            rel="tooltip" title="Edit category"
                                                            data-cate="{{ $category->category }}">
                                                            <i class="material-icons">edit</i>
                                                            <div class="ripple-container"></div>
                                                        </button>
                                                        <button type="button" title="Delete" rel="tooltip"
                                                            class="btn btn-danger btn-link delete" id="{{ $category->id }}">
    ...
    <div class="modal fade" id="category_delete" tabindex="-1" role="dialog" aria-labelledby="category_deleteTitle"
        aria-hidden="true">
