                    ...
                    <div class="card ">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10 ml-auto mr-auto">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" id="input-content"
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="col-sm-10 ml-auto mr-auto">
                                            <div class="form-group">
                                                <select
                                                    ...
                                                    <option disabled>Select primary post category</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10 ml-auto mr-auto">
                                            <div class="form-group">
                                                <label>Post categories seperated by comma</label>
                                                <textarea class="form-control" rows="3" id="input-content"
                                                    name="categories">{{ old('categories') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control inputFileVisible"
                                                placeholder="Primary post image..." value="">
                        ...
                        <div class="row m-1">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <textarea id="post" class="form-control mr-auto ml-auto {{ $errors->has('body') ? ' is-invalid' : '' }}" name="body">{{ old('body')}}</textarea>
                                </div>
                            </div>
                            @if ($errors->has('body'))
