                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row" style="display: none">
                                                <div class="col-sm-12">
                                                    <div class="alert alert-success">
                                                        ...
                                                        <input type="text" id="success_product"
                                                    ...
                                                    <div class="col-sm-10 ml-auto mr-auto">
                                                        <div
                                                            ...
                                                            <textarea id="input-description"
                                                                ...
                                                                rows="2" placeholder="describe the product"
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                    ...
                                                    <div class="col-sm-10 ml-auto mr-auto">
                                                        <div class="form-group">
                                                            <select
                                                                ...
                                                                data-style="btn btn-link" name="category_id"
                                                                id="input-category" required="true"
                                                                aria-required="true">
                                                                <option disabled selected>Select product category
                                                                </option>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10 ml-auto mr-auto">
                                                        <div
                                                            class="form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
                                                            <input
                                                                class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}"
                                                                name="quantity" id="input-quantity" type="text"
                                                                placeholder="{{ __('Quantity') }}"
                                                                value="{{ old('quantity') }}" required="true"
                                                                aria-required="true" />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10 ml-auto mr-auto">
                                                        <div class="form-group">
                                                            <select
                                                                class="form-control selectpicker {{ $errors->has('Sku') ? ' has-danger' : '' }}"
                                                                ...
                                                                <option value="{{$sku_num->id}}">{{$sku_num->sku_no}}
                                                                </option>
                                                                @endif
                                                                @endforeach
                                                                @endif
                                                ...
                                                <div
                                                    class="form-group form-file-upload
                                                ...
                                                @if ($errors->has('files'))
                                                <span id="p_file-error" style="margin-left: 10%"
...
<div class="modal fade" id="product_delete" tabindex="-1" role="dialog" aria-labelledby="product_deleteTitle"
    aria-hidden="true">
...
<div class="modal fade" id="product_edit" tabindex="-1" role="dialog" aria-labelledby="product_edit" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <h6 style="color:red;letter-spacing: 1px"><small>Uploading image will replaced the previous
                            image.</small></h6>
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <input class="form-control" name="edit_name" id="input-edit_name" type="text"
                                            placeholder="{{ __('Product name') }}" required="true"
                                            aria-required="true" />
                                        <span id="edit_product-error" class="error text-danger text-error"
                                            for="input-edit_name"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <textarea id="input-edit_description" class="form-control" rows="2"
                                            placeholder="describe the product" name="edit_description" required="true"
                                            aria-required="true"></textarea>
                                        <span id="edit_description-error" class="error text-danger text-error"
                                            for="input-edit_description"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <input class="form-control" name="edit_brand" id="input-edit_brand" type="text"
                                            placeholder="{{ __('Product Brand') }}" required="true"
                                            aria-required="true" />
                                        <span id="edit_brand-error" class="error text-danger text-error"
                                            for="input-edit_brand"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <textarea class="form-control" rows="2" id="input-edit_content" required="true"
                                            aria-required="true" placeholder="Content of product if available"
                                            name="edit_content"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <select class="form-control selectpicker" data-style="btn btn-link"
                                            name="edit_category_id" id="input-edit_category" required="true"
                                            aria-required="true">
                                        ...
                                        <span id="edit_category-error" class="error text-danger text-error"
                                            for="input-edit_category"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <input class="form-control" name="edit_price" id="input-edit_price" type="text"
                                            placeholder="{{ __('Product price') }}" required="true"
                                            aria-required="true" />
                                        <span id="edit_price-error" class="error text-danger text-error"
                                            for="input-edit_price"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        <input class="form-control" name="edit_quantity" id="input-edit_quantity"
                                            type="text" placeholder="{{ __('Quantity') }}" required="true"
                                            aria-required="true" />
                                        <span id="edit_quantity-error" class="error text-danger text-error"
                                            for="input-edit_quantity"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10 ml-auto mr-auto">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('Sku'))
                                        <span id="edit_sku-error" class="error text-danger"
                                            for="input-sku">{{ $errors->first('Sku') }}</span>
                                        @endif
                                    </div>
                                </div>
