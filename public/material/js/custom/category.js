                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        data.category.forEach(function (data) {
                            $n += 1;
                            $page +=
                                '<tr><td class="text-center">' + $n + "</td>";
                            $page +=
                                '<td class="text-center">' +
                                data.category +
                                "</td>";
                            $page +=
                                '<td class="td-actions text-center"><button rel="tooltip" title="Edit category" class="btn btn-info btn-link edit" id="' +
                                data.id +
                                '"';
                            $page +=
                                'data-cate="' +
                            ...
                            $page +=
                                '<button type="button" rel="tooltip" title="Delete" class="btn btn-danger btn-link delete" id="' +
                                data.id +
                                '"';
                            $page +=
                                '><i class="material-icons">close</i><div class="ripple-container"></div></button></td></tr>';
                        });
